...
public class CloudletSchedulerSpaceShared extends CloudletScheduler {
	...
	/** The cloudlet finished list. */
	private List<? extends ResCloudlet> cloudletPowerList;
	...
	public CloudletSchedulerSpaceShared() {
		...
		cloudletPowerList = new ArrayList<ResCloudlet>();
		usedPes = 0;
		currentCpus = 0;
	}
	...
	public double updateVmProcessing(double currentTime, List<Double> mipsShare) {
		...
		//System.out.println(getCloudletExecList().size());
	...
	public void cloudletFinish(ResCloudlet rcl) {
		...
		getCloudletPowerList().add(rcl); // chiyuan
		usedPes -= rcl.getNumberOfPes();
	}
	...
	public double getTotalUtilizationOfCpu(double time) {
		double totalUtilization = 0; // getCloudletFinishedList() // getCloudletFinishedList
		//for (ResCloudlet gl : getCloudletExecList()) {
		for (ResCloudlet gl : getCloudletPowerList()) { //getCloudletFinishedList()) {
			//System.out.println("xxxx");
			//System.out.println(gl);
	...
	@SuppressWarnings("unchecked")
	protected <T extends ResCloudlet> List<T> getCloudletPowerList() {
		return (List<T>) cloudletPowerList;
	}
	
	protected <T extends ResCloudlet> void setCloudletPowerList(List<T> cloudletFinishedList) {
		this.cloudletPowerList = cloudletPowerList;
	}
