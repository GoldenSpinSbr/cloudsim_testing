...
public class PowerDatacenter extends Datacenter {
	...
	protected void updateCloudletProcessing() {
		...
		if (getCloudletSubmitted() == -1 || getCloudletSubmitted() == CloudSim.clock()) {
			...
			//throw new RuntimeException("Intentional halt for debugging.");
			return;
		}
	...
	protected double updateCloudetProcessingWithoutSchedulingFutureEvents() {
		System.out.println("========== PowerDatacenter: updateCloudetProcessingWithoutSchedulingFutureEvents ==========");
	...
	protected void processVmMigrate(SimEvent ev, boolean ack) {
		System.out.println("========== PowerDatacenter: processVmMigrate ==========");
	...
	protected void processCloudletSubmit(SimEvent ev, boolean ack) {
		System.out.println("========== PowerDatacenter: processCloudletSubmit ==========");
	...
	public double getPower() {
		System.out.println("========== PowerDatacenter: getPower ==========");
		return power;
	}
	...
	protected void setPower(double power) {
		System.out.println("========== PowerDatacenter: setPower ==========");
		this.power = power;
	}
	...
	protected boolean isInMigration() {
		System.out.println("========== PowerDatacenter: isInMigration ==========");
	...
	public boolean isDisableMigrations() {
		System.out.println("========== PowerDatacenter: isDisableMigrations ==========");
	...
	public void setDisableMigrations(boolean disableMigrations) {
		System.out.println("========== PowerDatacenter: setDisableMigrations ==========");
	...
	protected double getCloudletSubmitted() {
		System.out.println("========== PowerDatacenter: getCloudletSubmitted ==========");
	...
	protected void setCloudletSubmitted(double cloudletSubmitted) {
		System.out.println("========== PowerDatacenter: setCloudletSubmitted ==========");
	...
	public int getMigrationCount() {
		System.out.println("========== PowerDatacenter: getMigrationCount ==========");
	...
	protected void setMigrationCount(int migrationCount) {
		System.out.println("========== PowerDatacenter: setMigrationCount ==========");
	...
	protected void incrementMigrationCount() {
		System.out.println("========== PowerDatacenter: incrementMigrationCount ==========");
