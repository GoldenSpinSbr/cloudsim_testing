...
public class v0 {
	...
	public v0() throws Exception {
        ...
        //	HOST_RAM, HOST_BW);
    	PowerDatacenter datacenter0 = PowerDatacenterCreator.createDatacenter(HOST_NUM, HOST_PES, HOST_MIPS, 
            	HOST_RAM, HOST_BW);
        
        // Create Broker
        broker0 = PowerBrokerCreator.createBroker();
        ...
        // Create Cloudlets
        cloudletList = CloudletCreator.createCloudlets(BROKER_ID, CLOUDLET_NUM, CLOUDLET_LEN, CLOUDLET_PES);
        ...
        */
        ...
        PowerVMScheduler.printVmCpuUtilization(vmList);
