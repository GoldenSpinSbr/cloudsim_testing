...
public class summarize {
	...
	public summarize() throws Exception {
		...
		for (Vm vm : vmList) {
		    if (vm.getHost() != null) {
		        System.out.println("VM1 #" + vm.getId() + " is allocated to Host #" + vm.getHost().getId());
		    } else {
		        System.out.println("VM1 #" + vm.getId() + " is not allocated to any host.");
		    }
		}
	...
	*/
	...
	private Host createPowerHost(final int id) {
        ...
        return new PowerHost(
                ...
                peList,
                new VmSchedulerTimeShared(peList),
                new PowerModelLinear(MAX_POWER, STATIC_POWER)
        );
        */
    }
    ...
    private List<Cloudlet> createCloudlets() {
        ...
        for (int i=0; i<CLOUDLETS; i++) {
            ...
            Cloudlet cloudlet = new Cloudlet(
                    ...
                    1000, // File size (bytes)
                    1000, // Output size (bytes)
